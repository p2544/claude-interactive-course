...
> **หมายเหตุ:** ไฟล์หนังสือต้นฉบับ (`manual500p.pdf`) ไม่ได้แจกใน repo นี้
> ถ้าคุณมีไฟล์หนังสือ ให้วางไว้ที่ `webapp/public/manual500p.pdf`
> ปุ่ม "📖 คู่มือ PDF ต้นฉบับ" ในแอปจะใช้งานได้ทันที
> (เว็บเวอร์ชันสาธารณะซ่อนปุ่มนี้ไว้โดย build ด้วย `VITE_ENABLE_PDF=false`)
